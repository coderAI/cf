...
class mb_e_invoices_report(models.Model):
    _name = 'mb.e.invoices.report'
    ...
    def _select(self):
        super(mb_e_invoices_report, self)._select()
        res = """
    ...
    def _from(self):
        super(mb_e_invoices_report, self)._from()
        from_str = """
                sale_order_line l
    ...
    def _group_by(self):
        super(mb_e_invoices_report, self)._group_by()
        group_by_str = """
    ...
    def init(self):
        ...
        _logger.info('==END running one time functions: %s'
                     % self._table)
        _logger.info('==END running one time functions: %s'
                     % self._select())
        _logger.info('==END running one time functions: %s'
